...
const QUERY_WORDS = [
  ...
  // 照護報告（交接給另一位照顧者）：新選單「出報告→照護使用」也走這裡
  { query: 'handoff', words: ['交班', '今日交班', '交班摘要', '交接', '照護報告', '照護使用', '照護交接'] },
  ...
  // 出報告入口：先問就醫／照護（見 index.js report 處理）
  { query: 'report', words: ['出報告', '產生報告', '要報告', '做報告', '報告'] },
  // 就醫報告（給醫生看）：新選單「出報告→就醫使用」也走這裡
  { query: 'visit', words: ['回診', '回诊', '看診', '看诊', '回診摘要', '給醫生', '給醫生看', '看醫生', '看診摘要', '就醫報告', '就醫使用'] },
